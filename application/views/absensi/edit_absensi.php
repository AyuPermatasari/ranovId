<body>
  ...
  <div class="left-content">
    ...
    <!-- header-starts -->
      ...
      <div class="col-sm-12">
        <div class="my-auto"><h1>Edit Data absensi</h1> 
          <br>
         ...
         <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
               <div class="panel panel-default">
                        <?php foreach ($get_absensi as $key) {
                        ?>
                        <div class="panel-body">
                <?php echo form_open_multipart('absensi/edit/'.$this->uri->segment(3)); ?>
                    <?php if (validation_errors()) {
                        ...
                        <div class="table-responsive">
                              ...
                              <div style="margin-top: 0px" class="form-group">
                                <label>tanggal</label>
                                <input class="form-control" id="tanggal" name="tanggal" type="date" placeholder="tanggal" value="<?php echo $key->tanggal; ?>">
                            </div>
                            <div style="margin-top: 0px" class="form-group">
                                <label>status</label>
                                <input class="form-control" id="status" name="status" type="text" placeholder="status" value="<?php echo $key->status; ?>">
                            </div>
