<body>
  ...
  <div class="left-content">
    ...
    <!-- header-starts -->
      ...
      <div class="col-sm-12">
        <div class="my-auto"><h1>Edit Data Admin</h1> 
          <br>
         ...
         <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
               <div class="panel panel-default">
                        <?php foreach ($get_admin as $key) {
                        ?>
                        <div class="panel-body">
                <?php echo form_open_multipart('Admin/edit/'.$this->uri->segment(3)); ?>
                    <?php if (validation_errors()) {
                        ...
                        <div class="table-responsive">
                            ...
                            <div style="margin-top: 0px" class="form-group">
                                <label>Email</label>
                                <input class="form-control" id="email" name="email" type="text" placeholder="Email" value="<?php echo $key->email; ?>">
                            </div>

                            <div style="margin-top: 0px" class="form-group">
                                <label>Nama Admin</label>
                                <input class="form-control" id="nama_adm" name="nama_adm" type="text" placeholder="Nama Admin" value="<?php echo $key->nama_adm; ?>">
                            </div>
