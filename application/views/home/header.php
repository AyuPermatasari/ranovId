...
<!DOCTYPE html>
	...
	<link rel="stylesheet" href="<?php echo base_url('') ?>assets/home/css/morris.css" type="text/css"/>
	<!-- calendar -->
	<link rel="stylesheet" href="<?php echo base_url('') ?>assets/home/css/monthly.css">
	<!-- //calendar -->
	<!-- //font-awesome icons -->
	<script src="<?php echo base_url('') ?>assets/home/js/jquery2.0.3.min.js"></script>
	<script src="<?php echo base_url('') ?>assets/home/js/raphael-min.js"></script>
	<script src="<?php echo base_url('') ?>assets/home/js/morris.js"></script>
	</head>
