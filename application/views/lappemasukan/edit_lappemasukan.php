<body>
  ...
  <div class="left-content">
    ...
    <!-- header-starts -->
      ...
      <div class="col-sm-12">
        <div class="my-auto"><h1>Edit Data lappemasukan</h1> 
          <br>
         ...
         <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
               <div class="panel panel-default">
                        <?php foreach ($get_lappemasukan as $key) {
                        ?>
                        <div class="panel-body">
                <?php echo form_open_multipart('lappemasukan/edit/'.$this->uri->segment(3)); ?>
                    <?php if (validation_errors()) {
                        ...
                        <div class="table-responsive">
                              ...
                              <div style="margin-top: 0px" class="form-group">
                                <label>tanggal</label>
                                <input class="form-control" id="tgl_pemasukan" name="tgl_pemasukan" type="date" placeholder="tgl_pemasukan" value="<?php echo $key->tgl_pemasukan; ?> ">
                            </div>
