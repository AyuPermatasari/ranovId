<body>
  ...
  <div class="left-content">
    ...
    <!-- header-starts -->
      ...
      <div class="col-sm-12">
        <div class="my-auto"><h1>Pegawai <a id="myBtn" class="btn btn-success" role="button"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Tambah</a></h1> 
          <br>
          ...
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div style="margin-top: 25px; margin-left: 300px; width: 70%" class="modal-content">
                                    <div class="modal-header" style="background-color: #b80020">
                                        ...
                                        <h2>Pegawai <i class="glyphicon glyphicon-tasks"></i></h2>
                                    </div>
                                    <div class="modal-body">
                                        ...
                                        <div style="margin-top: " class="form-group">
                                            ...
                                            <input class="form-control" id="nama_pegawai" type="text" name="nama_pegawai" value="<?php echo set_value('nama_pegawai') ?>" placeholder="Nama Pegawai">
                                        </div>
                                        <div style="margin-top: " class="form-group">
                                            <label>Alamat</label>
                                            <input class="form-control" id="alamat_pegawai" type="text" name="alamat_pegawai" value="<?php echo set_value('alamat_pegawai') ?>" placeholder="Alamat Pegawai">
                                        </div>
                                        <div style="margin-top: " class="form-group">
                                            <label>NO. Hp</label>
                                            <input class="form-control" id="nohp_pegawai" type="number" name="nohp_pegawai" value="<?php echo set_value('nohp_pegawai') ?>" placeholder="No. Hp">
                                        </div>
                                        <div style="margin-top: " class="form-group">
                                            <label>Jabatan</label>
          ...
          <table class="table table-bordered table-hover" style="float: right;" id="example">
            <thead>
                <tr>
                    ...
                    <th width="10%">Alamat Pegawai</th>
                    <th width="15%">No. Hp</th>
                    <th width="15%">Jabatan</th>
                    <th width="18%">Action</th>
                </tr>
            </thead>
            <tbody><?php foreach ($data_pegawai as $key) { ?>
                <tr>
                    ...
                    <td><a href="<?php echo site_url('Pegawai/edit/').$key->id_pegawai ?>" type="button" class="btn btn-success"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>Edit</a> | <a href="<?php echo site_url('Pegawai/delete/').$key->id_pegawai ?>" type="button" class="btn btn-danger" onClick="JavaScript: return confirm('Anda yakin Hapus data ini ?')"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>Hapus</a></td>
